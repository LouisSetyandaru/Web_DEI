...
@section('content')
    ...
    <div class="video mb-8 w-full flex flex-col items-center"> <!-- Menambahkan mb-8 untuk margin bawah lebih besar -->
    ...
    <div class="container mx-auto py-8">
        <div class="flex flex-col md:flex-row items-center md:justify-between space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div class=" mx-auto text-white md:w-2/3">
                ...
                <p class="mt-4">DIGPRO adalah mitra digital bagi UMKM, menyediakan solusi handal dengan kerjasama penyedia layanan website,
                    ...
                    dalam era digital. Bergabunglah dengan DIGPRO sekarang dan lihat bagaimana kami dapat
    ...
    <div class="content-two">
        ...
        <div class="container mx-auto py-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <!-- Card 1 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md">
                    <img class="w-full h-48 object-cover object-center" src="../../resources/images/card1.jpg" alt="Image">
                    <div class="p-6 space-y-4"> <!-- Increased padding and added spacing between elements -->
                        <h2 class="font-bold text-xl mb-2 text-center text-red-400">Paket 1 Bulan</h2> <!-- Center aligned and slightly larger font size -->
                        <ul class="list-disc pl-5 text-gray-600 space-y-2"> <!-- Used list for better readability and spacing between list items -->
                        ...
                        <h1 class="font-bold text-xl text-center text-red-400">Hanya Rp.250.000</h1> <!-- Center aligned and colored price -->
                    </div>
                ...
                <!-- Card 2 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-md">
                    <img class="w-full h-48 object-cover object-center" src="../../resources/images/card2.jpg" alt="Image">
                    <div class="p-6 space-y-4">
                        ...
                        <h1 class="font-bold text-xl text-center text-red-400">Hanya Rp.690.000</h1> <!-- Center aligned and colored price -->
                    </div>
                    <div class="p-4 flex justify-center"> <!-- Added padding and centered the button -->
                        <form class="div-form" action="langganan_form.blade.php" method="get">
                            <button class="button1">Coba Sekarang</button>
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-md">
                    <img class="w-full h-48 object-cover object-center" src="../../resources/images/card2.jpg" alt="Image">
                    <div class="p-6 space-y-4"> <!-- Increased padding and added spacing between elements -->
                        <h2 class="font-bold text-xl mb-2 text-center text-red-400">Paket 6 Bulan</h2> <!-- Center aligned and slightly larger font size -->
                        <ul class="list-disc pl-5 text-gray-600 space-y-2"> <!-- Used list for better readability and spacing between list items -->
                        ...
                        <h1 class="font-bold text-xl text-center text-red-400">Hanya Rp.1.450.000</h1> <!-- Center aligned and colored price -->
                    </div>
                    <div class="p-4 flex justify-center"> <!-- Added padding and centered the button -->
                        <form class="div-form" action="langganan_form.blade.php" method="get">
                            <button class="button1">Coba Sekarang</button>
